    ...
    Public Class CryptoUtil
        ...
        Public Shared Function Encrypt(ByVal value As String) As String
            If value <> "" Then
                ...
                Dim cs As CryptoStream =
                    New CryptoStream(ms, cryptoProvider.CreateEncryptor(KEY_64, IV_64),
        ...
        Public Shared Function Decrypt(ByVal value As String) As String
            If value <> "" Then
                ...
                Dim cs As CryptoStream =
                    New CryptoStream(ms, cryptoProvider.CreateDecryptor(KEY_64, IV_64),
        ...
        Public Shared Function EncryptTripleDES(ByVal value As String) As String
            If value <> "" Then
                ...
                Dim ms As MemoryStream = New MemoryStream
                Dim cs As CryptoStream =
                    New CryptoStream(ms, cryptoProvider.CreateEncryptor(KEY_192, IV_192),
                        CryptoStreamMode.Write)
                Dim sw As StreamWriter = New StreamWriter(cs)
        ...
        Public Shared Function DecryptTripleDES(ByVal value As String) As String
            If value <> "" Then
                ...
                Dim ms As MemoryStream = New MemoryStream(buffer)
                Dim cs As CryptoStream =
                    New CryptoStream(ms, cryptoProvider.CreateDecryptor(KEY_192, IV_192),
                        CryptoStreamMode.Read)
                Dim sr As StreamReader = New StreamReader(cs)
