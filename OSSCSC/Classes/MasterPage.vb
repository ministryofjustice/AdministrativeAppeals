...
Namespace Web
    Public Class MasterPage
        ...
        Protected Sub BuildFramework()
            Me.HeaderPlaceHolder.Controls.Add(Me.LoadControl("~/UserControls/Header.ascx"))
            Me.HeaderPlaceHolder.Controls.Add(Me.LoadControl("~/UserControls/Links.ascx"))
            Me.FooterPlaceHolder.Controls.Add(Me.LoadControl("~/Usercontrols/Footer.ascx"))
            Me.Response.Expires = -1
            Me.Response.AddHeader("pragma", "no-cache")
            Me.Response.CacheControl = "Private"
            Me.Controls.Add(New LiteralControl("<?xml version=""1.0"" encoding=""iso-8859-1""?>" & ChrW(10)))
            Me.Controls.Add(New LiteralControl("<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN"" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"">" & ChrW(10)))
            Me.Controls.Add(New LiteralControl("<html xmlns=""http://www.w3.org/1999/xhtml"" lang=""en"" xml:lang=""en"">" & ChrW(10)))
            ...
            Me.Controls.Add(New LiteralControl("<style>body {margin:10px;}</style>" & ChrW(10)))
            Me.Controls.Add(New LiteralControl("</head>" & ChrW(10)))
            Me.Controls.Add(New LiteralControl("<body>" & ChrW(10)))
            If Me.DisplayHeader Then
                Me.Controls.Add(Me.HeaderPlaceHolder)
            End If
            Me.Controls.Add(New LiteralControl("<div id=""mainbox""><a id=""skipnav""></a>" & ChrW(10)))
            Me.Controls.Add(New LiteralControl("<!-- InstanceBeginEditable name=""mainbox"" -->" & ChrW(10)))
            Me.Controls.Add(Me.ContentPlaceHolder)
            Me.Controls.Add(New LiteralControl("<!-- InstanceEndEditable -->" & ChrW(10)))
        ...
        Protected Overridable Sub PopulateTitle()
            Me.Controls.Add(New LiteralControl("<title>OSSCSC</title>" & ChrW(10)))
        End Sub
